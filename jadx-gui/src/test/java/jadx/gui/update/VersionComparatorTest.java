...
class VersionComparatorTest {
	...
	@CsvSource(
		{
				"1,2, -1", "v2.0,1.2, 1", "2.0,v2, 0", "v2.1,v2.1, 0", "02.1,2.1.0, 0", "v02.1,3, -1", "03,v2.1, 1", "v03,v2, 1"
				// ,"2.3,02, 1"
				, "v2.2,02.2, 0", "2,v03, -1", "v1,v01, 0", "02,02.0, 0", "v02,02, 0", "3.03, v2.3, 1", "v02.3,v03, -1"
		}
	)
	...
	@CsvSource(
		{
				...
				// ,"-3, -2, -2"
				// ,"2, -3, -2"
				"a, b, -2", "3, a, -2", "a, 2, -2", "A, B, -2", "3, A, -2", "A, 3, -2", "C, b, -2", "a, B, -2",
				"2147483647, 3, 1", "3, 2147483647, -1", "2147483648, 3, -2", "3, 2147483648, -2", "2147483648, 2147483649, -2",
				"%, *, -2", "%, #, -2", "*, %, -2"
		}
	)
